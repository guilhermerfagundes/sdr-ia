...
def test_mensagem_personalizada_com_nome_e_oportunidade():
    ...
    cfg = {"mensagem": {"remetente": "Gui", "agencia": "DemandOS", "proposta": "atrair clientes"}}
...
def test_link_whatsapp_normaliza_numero():
    ...
    assert link.startswith("https://wa.me/5511988880001?text=")
...
def test_link_whatsapp_ja_com_55():
    ...
    assert link.startswith("https://wa.me/551136051200?text=")
